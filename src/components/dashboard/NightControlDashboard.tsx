...
export default function NightControlDashboard({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="p-6 rounded-2xl bg-gradient-to-r from-purple-950/60 via-zinc-900/90 to-zinc-950 border border-purple-500/20 backdrop-blur-xl">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          <div className="space-y-1.5">
            ...
            <h1 className="text-2xl sm:text-3xl font-black text-white tracking-tight flex items-center gap-3">
              ...
              {data?.hasActiveEvent && (
                <span className="flex items-center gap-1.5 text-xs font-semibold px-2.5 py-1 rounded-full bg-emerald-950/80 text-emerald-300 border border-emerald-500/40 animate-pulse">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            <Link
              href="/dashboard/dj"
              className="px-3.5 py-2 rounded-xl bg-purple-600 hover:bg-purple-500 text-white text-xs font-bold transition-all flex items-center gap-2 shadow-lg shadow-purple-600/30 group"
            >
            ...
            {data?.event?.code && (
              <a
                ...
                className="px-3.5 py-2 rounded-xl bg-zinc-900 hover:bg-zinc-800 border border-zinc-700 text-cyan-300 text-xs font-bold transition-all flex items-center gap-2"
              >
            ...
            <Link
              ...
              className="px-3.5 py-2 rounded-xl bg-zinc-900 hover:bg-zinc-800 border border-zinc-800 text-zinc-300 text-xs font-medium transition-all flex items-center gap-2"
            >
        ...
        {data?.activeEvents && data.activeEvents.length > 1 && (
          <div className="mt-4 pt-3 border-t border-zinc-800 flex items-center gap-2 text-xs">
            ...
            <select
              ...
              className="px-3 py-1 bg-zinc-950 border border-zinc-800 rounded-lg text-white font-medium focus:outline-none focus:border-purple-500"
            >
