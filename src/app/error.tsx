...
export default function GlobalErrorBoundary({
  ...
  return (
    <div className="min-h-screen bg-[#070709] flex flex-col items-center justify-center p-6 text-center">
      <div className="w-16 h-16 rounded-2xl bg-purple-500/10 border border-purple-500/20 text-purple-400 flex items-center justify-center mb-5 shadow-lg shadow-purple-500/10">
        <AlertCircle className="w-8 h-8" />
      </div>

      <h1 className="text-2xl font-black text-white tracking-tight mb-2">
        Vidjs Entertainment OS
      </h1>

      <p className="text-sm text-zinc-400 max-w-md mb-6 leading-relaxed">
        Se presentó una eventualidad al procesar la solicitud en caliente. Puedes reintentar la operación o volver a autenticarte.
      </p>
      ...
      <div className="flex flex-wrap items-center justify-center gap-3">
        ...
        <Link
          href="/"
          className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-zinc-900 hover:bg-zinc-800 border border-zinc-800 text-zinc-300 text-xs font-semibold transition-all"
        >
